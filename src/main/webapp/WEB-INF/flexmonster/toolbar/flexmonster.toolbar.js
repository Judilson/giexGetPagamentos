...
FlexmonsterToolbar.prototype.getTabs = function () {
    ...
    tabs.push({
        ...
        menu: [
            { title: Labels.charts_bar, id: "fm-tab-charts-bar", handler: this.chartsHandler, args: "bar", icon: this.icons.charts },
...
FlexmonsterToolbar.prototype.showOptionsDialog = function () {
    ...
    noSubTotalsCbx.id = "fm-st-1";
    noSubTotalsCbx.value = "false";
    itemWrap.appendChild(noSubTotalsCbx);
    var label = document.createElement("label");
    ...
    showSubTotalsCbx.id = "fm-st-2";
    showSubTotalsCbx.value = "true";
    itemWrap.appendChild(showSubTotalsCbx);
    var label = document.createElement("label");
